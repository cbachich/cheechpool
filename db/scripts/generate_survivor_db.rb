...
andrea = bikal.players.create(name: "Andrea", image_url: "http://wwwimage.cbsstatic.com/base/files/styles/136x170/public/cast/andrea_boehlke.jpg", league_id: league.id)
