...
cheech_smack = cheech.smacks.create(content: "Make sure to post some smack on here... about each other... not the website or me! I'll ban anyone saying anything bad about CheechPool!")
cheech_smack.league_id = survivor.id
cheech_smack.save
